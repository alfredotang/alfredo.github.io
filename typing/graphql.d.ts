declare namespace Typing {
    ...
    export type SiteFieldsEnum =
        ...
        | 'siteMetadata___deploy___site_name'
        | 'siteMetadata___deploy___short_name'
        | 'siteMetadata___deploy___site_url'
        | 'siteMetadata___deploy___repo_url'
        | 'siteMetadata___deploy___repo_name'
        | 'siteMetadata___deploy___path_prefix'
        | 'siteMetadata___deploy___site_icon'
        | 'siteMetadata___deploy___version'
        | 'port'
        | 'host'
        | 'pathPrefix'
        | 'polyfill'
    ...
    export type SiteSiteMetadata = {
        ...
        deploy?: Maybe<SiteSiteMetadataDeploy>;
    };

    export type SiteSiteMetadataDeploy = {
        site_name?: Maybe<Scalars['String']>;
        short_name?: Maybe<Scalars['String']>;
        site_url?: Maybe<Scalars['String']>;
        repo_url?: Maybe<Scalars['String']>;
        repo_name?: Maybe<Scalars['String']>;
        path_prefix?: Maybe<Scalars['String']>;
        site_icon?: Maybe<Scalars['String']>;
        version?: Maybe<Scalars['String']>;
    };

    export type SiteSiteMetadataDeployFilterInput = {
        site_name?: Maybe<StringQueryOperatorInput>;
        short_name?: Maybe<StringQueryOperatorInput>;
        site_url?: Maybe<StringQueryOperatorInput>;
        repo_url?: Maybe<StringQueryOperatorInput>;
        repo_name?: Maybe<StringQueryOperatorInput>;
        path_prefix?: Maybe<StringQueryOperatorInput>;
        site_icon?: Maybe<StringQueryOperatorInput>;
        version?: Maybe<StringQueryOperatorInput>;
    };
    ...
    export type SiteSiteMetadataFilterInput = {
        ...
        deploy?: Maybe<SiteSiteMetadataDeployFilterInput>;
    };
        ...
        site?: Maybe<{
            siteMetadata?: Maybe<
                Pick<SiteSiteMetadata, 'title' | 'description' | 'author'> & {
                    deploy?: Maybe<Pick<SiteSiteMetadataDeploy, 'site_url' | 'path_prefix'>>;
                }
            >;
        }>;
    };
    ...
    export type BlogPostQueryQuery = {
        mdx?: Maybe<
            Pick<Mdx, 'id' | 'body'> & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'tag' | 'category'>> }
        >;
    };
        ...
        allMdx: {
            edges: Array<{
                node: Pick<Mdx, 'id' | 'excerpt'> & {
                    frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'tag' | 'category'>>;
